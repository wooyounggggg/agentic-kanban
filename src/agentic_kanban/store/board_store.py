...
from agentic_kanban.models.worklog import (
    WorklogEntry,
    read_worklog as _read_worklog,
    append_worklog as _append_worklog,
)
from agentic_kanban.models.agent import AgentSession
...
class BoardStore:
    ...
    def read_issue(self, ticket: str) -> Issue:
        """Load and return the :class:`~agentic_kanban.models.issue.Issue` for *ticket*."""
    ...
    def read_checklist(self, ticket: str) -> Checklist:
        """Load and return the :class:`~agentic_kanban.models.checklist.Checklist` for *ticket*.
    ...
    def read_worklog(self, ticket: str) -> List[WorklogEntry]:
        """Return all :class:`~agentic_kanban.models.worklog.WorklogEntry` objects for *ticket*."""
    ...
    def read_agent(self, ticket: str) -> AgentSession:
        """Load and return the :class:`~agentic_kanban.models.agent.AgentSession` for *ticket*.
    ...
    def read_config(self) -> BoardConfig:
        """Load and return the :class:`~agentic_kanban.models.config.BoardConfig`.
